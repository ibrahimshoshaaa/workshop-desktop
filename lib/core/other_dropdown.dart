...
/// قائمة منسدلة عامة (لأي شاشة في التطبيق) بيها خيار "أخرى" ثابت في
/// الآخر - لو المستخدم اختاره، بيظهر تلقائيًا حقل نصي تحت القائمة يقدر
/// يكتب فيه القيمة اللي عايزها، وده اللي بيتخزن فعليًا (مش كلمة "أخرى"
/// نفسها). لو كانت القيمة الحالية مش موجودة أصلاً في قائمة الخيارات
/// الثابتة (لأنها اتكتبت يدوي قبل كده)، الودجت بيتعامل معاها تلقائيًا
/// كأنها "أخرى" ويحط قيمتها في الحقل النصي.
class OtherCapableDropdown extends StatefulWidget {
  /// الخيارات الثابتة (من غير "أخرى" - بتتضاف أوتوماتيك في الآخر)
