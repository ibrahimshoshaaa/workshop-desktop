...
class AppUserModel {
  ...
  /// كل الشاشات اللي ممكن تتحدد صلاحية دخول ليها. نفس القايمة بالظبط
  /// الموجودة في نسخة الموبايل (UserAccountModel.permissionScreens) عشان
  /// شاشة إدارة الصلاحيات تطلع متطابقة في التطبيقين - أي تعديل هنا لازم
  /// يتعمل في نسخة الموبايل كمان. الإعدادات مستثناة عمدًا (للأدمن بس،
  /// لأنها بتدي تحكم كامل في كل الحسابات والباسوردات)
