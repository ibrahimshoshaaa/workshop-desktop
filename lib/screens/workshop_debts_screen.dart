...
class WorkshopDebtsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<WorkshopDebtsScreen> createState() =>
      _WorkshopDebtsScreenState();
}
...
class _WorkshopDebtsScreenState extends ConsumerState<WorkshopDebtsScreen> {
  ...
  Future<void> _showDebtDialog(BuildContext context, WidgetRef ref,
      {WorkshopDebt? debt}) async {
    final formKey = GlobalKey<FormState>();
    final nameController =
        TextEditingController(text: debt?.creditorName ?? '');
                ...
                children: [
                  TextFormField(
                    ...
                    decoration: _fieldDecoration(
                        'اسم المورد / الصنايعي', Icons.storefront_outlined),
                    validator: (v) =>
                  ...
                  TextFormField(
                    ...
                    decoration: _fieldDecoration(
                        'إجمالي المديونية (ج.م)', Icons.request_quote_outlined),
  ...
  Future<void> _showPayDialog(
      BuildContext context, WidgetRef ref, WorkshopDebt debt) async {
    final formKey = GlobalKey<FormState>();
              ...
              child: Column(
                ...
                children: [
                  Align(
                    ...
                    child: Text(
                        'المتبقي حاليًا: ${debt.remaining.toStringAsFixed(0)} ج.م',
                  ...
                  TextFormField(
                    ...
                    keyboardType: TextInputType.number,
                    decoration: _fieldDecoration(
                        'المبلغ المسدد (ج.م)', Icons.payments_outlined),
                    validator: (v) {
  ...
  Widget build(BuildContext context) {
    ...
    final filteredDebts = q.isEmpty
        ? debts
        : debts
            .where((d) => normalizeForSearch(d.creditorName).contains(q))
            .toList();
          ...
          if (debts.isEmpty)
            const Expanded(
                child: _EmptyState(
                    ...
                    text: 'لا توجد مديونيات على الورشة حاليًا 🎉'))
          else ...[
            Padding(
              ...
              child: _HeroStatCard(
                ...
                caption:
                    '${debts.where((d) => d.remaining > 0).length} مديونية لسه مستحقة',
                icon: Icons.storefront_rounded,
              ...
              child: filteredDebts.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final color =
                            isSettled ? AppColors.success : AppColors.danger;
                        return Padding(
